...
<%
    ...
    //다운로드할 파일명 얻기 
    //(어디에 있을까? 배포된 경로에 있겠지 그래서 밑에 물리적경로를 얻는거야)
    ...
    /*
    자바에서는 파일에서 바이트 단위로 입력할 수 있도록 하기 위해서
    FileInputStream 클래스를 제공
    이 클래스를 다른 입력 관련 클래스와 연결해서 파일에서 데이터를 읽거나 쓸수 있습니다
    */
    ...
    if(sMimeType == null){
     ...
     //MIME이란? Multipurpose Internet Mail Extensions의 약자로 
  	 //간략히 말씀을 드리면 파일 변환을 뜻한다고할 수 있습니다.
    ...
    //문서를 읽어 들여서 ISO8859_1 형식으로 변환 ......이렇게 해줘야 안깨져요
