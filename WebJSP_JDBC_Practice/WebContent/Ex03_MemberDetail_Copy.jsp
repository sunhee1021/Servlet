...
/*  
	회원 상세 페이지 (id 컬럼 PK)
	1.권한 검사 (회원상세 페이지는 admin만이 가능하니까)
			...
			<td style="width: 700px">
				...
				<%
				  		...
				  		try{
				  			...
				  			while(rs.next()){
				  				//데이터가 있다면 while문을 돌면서
				  %>
				  				<!-- 테이블을 만들어서 각 row와 data가 들어갈수 있게 함 -->
				  			 <table style="width: 400px;height: 100px;margin-left: auto;margin-right: auto;">
				  			 	<tr>
				  			 	...
				  			 	<tr>
				  			 		...
				  			 		<td colspan="2">
				  			 			...
				  			 			<!-- 회원정보를 확인하고나서 회원리스트 페이지로 이동할수 있는 링크 
				  			 				 목록가기를 누르면 Ex03_Memberlist.jsp 페이지(링크)로 이동-->
				  			 		</td>
				  			 	</tr>
				  			 </table>	
				  <%				
